...
ui <- dashboardPage(
  # HEADER
  dashboardHeader(title = "Cityscape - Find your perfect city!"),
  dashboardSidebar(
        collapsed = TRUE
  ),
  ...
  dashboardBody(
    ...
    fixedRow(
      ...
      column(width = 3,
        box(title = "Intermediate Rankings",
          solidHeader = T,
          width = "100%",
          collapsible = T,
          collapsed = F,
      ...
      column(
        width = 3,
        box(title = "City Factors by Weight", solidHeader = T,
            width = "100%", collapsible = T,
